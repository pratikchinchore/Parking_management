        ...
        <section id="breadcrumbs" class="breadcrumbs">
            <div class="container mt-5">
                <ol>
                    ...
                    <li>Book a Parking</li>
                </ol>
                <h2>Book a Parking</h2>
                                ...
                                <form action="<?php echo e(route('book_vehicle')); ?>" method="post" role="form"
                                    ...
                                    <div class="row">
                                        <input type="text" name="vehicle_number" id="vehicle_number"
                                            class="form__input" placeholder="Vehicle Number" required>
                                    </div>
                                    <div class="" style="margin-bottom:-3%;color:darkcyan;">
                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            Your Booking is done successfilly
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\xampp\htdocs\park_project\resources\views/booking.blade.php ENDPATH**/ ?>